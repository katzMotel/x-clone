...
export default function MainContent() {
    ...
    const { user } = useAuth();
    const Image = fixIcon(FaImage);
    const Smile = fixIcon(FaSmile);
    const Poll = fixIcon(FaPoll);
    const CalendarAlt = fixIcon(FaCalendarAlt);
    const MapMarkerAlt = fixIcon(FaMapMarkerAlt);
    const Bold = fixIcon(FaBold);
    const Italic = fixIcon(FaItalic);
    const UserCircle = fixIcon(FaUserCircle);
            ...
            <form onSubmit={handleSubmit} className={styles.tweetInput}>
                <div className={styles.inputContainer}>
                    {avatarUrl ? (
                        ...
                        <UserCircle className={styles.profileIcon} /> // Use the icon if user is not logged in
                    )}
                    <textarea
                ...
                <div className={styles.iconsContainer}>
                    ...
                    <CalendarAlt className={styles.icon} />
